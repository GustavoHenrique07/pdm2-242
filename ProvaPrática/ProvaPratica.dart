...
Future<void> main() async {
  ...
  print("nome: Gustavo Henrique Chaves de Carvalho");
  ...
  await inserirAluno(db, 'Gustavo Henrique', 18);
  await inserirAluno(db, 'Cauã Ícaro', 17);

  // Consultar dados de forma assíncrona
  await consultarAlunos(db);

  // Atualizar dados de forma assíncrona
  await atualizarAluno(db, 1, 'Cauã Modificado', 18);
